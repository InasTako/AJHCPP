...
{
public:
    // 순수 가상함수는 무조건 하위 클래스에서 재정의를 해야합니다.
    void Draw()
    {
        cout << "동그라미" << endl;
    }
...
int main()
{
    ...
    // 가상함수 테이블이 실제 호출되어야 할 함수의 위치를 저장하고 있습니다.
    ...
    */
    ...
    // 상속받은 클래스에서도 순수 가상함수들을 모두 다 재정의 해야만 생성할 수 있습니다.
    // 필요한 모든 클래스가 구현될 수 있도록하여 안정성을 높이는데 큰 효과를 줍니다.
